const RentalBookingModule = (function () {
    ...
    function generateDailyRateOptions(scheme, optionsContainer) {
        ...
        document.querySelector('input[value="full_day_with_hours"]').addEventListener('change', function () {
            ...
            updateDayHourCostDisplay();
        });

        // Update the cost display dynamically as the user inputs a value
        document.getElementById('dayBlockValue').addEventListener('input', updateDayCostDisplay);
        document.getElementById('dayHourBlockValueDays').addEventListener('input', updateDayHourCostDisplay);
        document.getElementById('dayHourBlockValueHours').addEventListener('input', updateDayHourCostDisplay);
    }

    function updateDayCostDisplay() {
    ...
    function updateDayHourCostDisplay() {
