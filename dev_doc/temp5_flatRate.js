const RentalBookingModule = (function () {
   // const productIdElement = document.getElementById('rental_booking_productid');
    ...
    function handleBooking() {
        ...
        createDraftOrder(schemeId, selectedScheme.dataset.scheme, numberOfBlocks, rentalStartDate, rentalStartTime);
    }

    async function createDraftOrder(schemeId, schemeType, numberOfBlocks, rentalStartDate, rentalStartTime) {
